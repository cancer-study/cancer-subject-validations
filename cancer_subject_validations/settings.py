"""
Django settings for cancer_subject_validations project.
...
APP_NAME = 'cancer_subject_validations'
...
ROOT_URLCONF = 'cancer_subject_validations.urls'
...
WSGI_APPLICATION = 'cancer_subject_validations.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'cancer_subject_validations', 'static')
STATIC_URL = '/static/'
DEVICE_ID = '99'
